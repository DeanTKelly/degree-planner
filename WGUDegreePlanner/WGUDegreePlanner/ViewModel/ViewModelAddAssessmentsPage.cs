...
{
    public class ViewModelAddAssessmentsPage : ViewModelBase
    {    
        ...
        public ViewModelAddAssessmentsPage(Course course)
        {
            assessmentValue = new Assessment();
            CourseID = course.CourseID;
            AssessmentStartDate = DateTime.Now.ToShortDateString();
            AssessmentEndDate = DateTime.Now.AddMonths(1).ToShortDateString();
        ...
        {
            return assessment.AssessmentName != null && assessment.AssessmentType != null;
        }
        ...
        async Task ExecuteSaveButtonCommand()
        {
            ...
            MessagingCenter.Send<ViewModelAddAssessmentsPage, Assessment>(this, "AddAssessment", Assessment);
            }
            else
            {
